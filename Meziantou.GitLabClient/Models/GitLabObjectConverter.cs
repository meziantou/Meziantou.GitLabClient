...
{
    public class GitLabObjectConverter : JsonConverter<GitLabObject>
    {
        ...
        public override GitLabObject ReadJson(JsonReader reader, Type objectType, GitLabObject existingValue, bool hasExistingValue, JsonSerializer serializer)
        {
            if (reader.TokenType == JsonToken.StartObject)
            {
                ...
                var gitLabObject = (GitLabObject)Activator.CreateInstance(objectType, BindingFlags.Instance | BindingFlags.NonPublic, null, new object[] { obj }, null);
